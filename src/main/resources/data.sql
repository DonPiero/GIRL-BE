...
INSERT INTO Experiments (id, name, date, userId, experiment_state, model, instances, epsilon, decay, alpha, discount, runs, epochs, experiment_limit, generate_graph) VALUES
      ...
      (13, 'Experiment 3', '2024-03-01', 11, 0, 3, 'Instance 3', 4, 3, 20, 30, 70, 300, 2000, TRUE),
